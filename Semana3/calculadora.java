...
public void setPi(int QUANTASCASAS){ throw new UnsupportedOperationException();
    ...
    public static void EhPotenciaDe10 (int[] potencias, int valor) {
        ...
        for (int i = 0; i < potencias.length; i++) {
            ...
            System.out.println("Linha para controlo do que eh executado. Encontrei um problema neste metodo que nao faz o que eh suposto fazer!");
        }
    }
